---
summary: Subtracto Horizontal Empaquetado y Saturate
---

## Descripción

(V)PHSUBSW realiza la resta horizontal en cada par adyacente de 16 bits enteros con signo restando la palabra mas significativo de la palabra menos significativo de cada par en la fuente y operandos de destino. Los resultados firmados y saturados de 16 bits están empaquetados al operando de destino (primer operando). Cuando el operando de origen es un operando de memoria de 128 bits, el operando debe estar alineado en un límite de 16 bytes o una excepción de protección general (#GP) se generará.
