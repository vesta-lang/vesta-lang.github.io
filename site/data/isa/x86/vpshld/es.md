---
summary: Datos empaquetados de concatenado y de desplazamiento
---

## Descripción

Datos empaquetados concatenados, resultado de extracto se desplaza a la izquierda por valor constante. Esta instrucción admite la supresión de la falla de memoria.
