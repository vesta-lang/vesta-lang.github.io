---
summary: Divide Packed FP16 Valores
---

## Descripción

Esta instrucción divide los valores de FP16 empaquetados del primer operando de origen por los elementos correspondientes en el segundo operando de origen, almacenando el resultado FP16 empaquetado en el operando de destino. Los elementos de destino se actualizan según la máscara de escritura.
