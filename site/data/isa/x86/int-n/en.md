...
* FRED event delivery uses event type 4 (software interrupt) for INT n but uses event type 5 (privileged software

exception) for INT1 and event type 6 (software exception) for INT3 and INTO.
