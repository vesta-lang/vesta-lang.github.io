---
summary: Análisis de bits
---

## Descripción

Busca el operando de origen (segundo operando) para el bit mas significativo fijado (1 bit). Si se encuentra un bit mas significativo, su índice de bits se almacena en el operando de destino (primer operando). El operando de origen puede ser un registro o una ubicación de memoria; el operando de destino es un registro. El índice de bits es un offset sin firmar del bit 0 del operando de origen. Si el contenido operando de origen es cero, el operando de destino no está modificado.1
