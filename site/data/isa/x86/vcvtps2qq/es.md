...
Convierte ocho valores en coma flotante de precisión simple empaquetados en el operando de origen a ocho enteros de cuádpago firmados en el operando de destino.
