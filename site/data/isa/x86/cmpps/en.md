...
Compilers and assemblers may implement the following two-operand pseudo-ops in addition to the three-operand CMPPS instruction, for processors with "CPUID.01H:ECX.AVX[28] = 0". See Table 3-11. The compiler should treat reserved imm8 values as illegal syntax.
