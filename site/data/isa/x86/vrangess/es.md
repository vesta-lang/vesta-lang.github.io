...
Esta instrucción calcula una salida de operación de rango de dos entradas valores en coma flotante de precisión simple en el elemento bajo dword del primer operando de origen (el segundo operando) y segundo operando de origen (el tercer operando). La salida de rango está escrita al elemento de palabra baja del operando de destino (el primer operando) bajo la máscara de escritura k1.
...
Los bits 128:31 del operando de destino son copiados de los elementos respectivos del primer operando de origen.
