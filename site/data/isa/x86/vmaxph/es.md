---
summary: Máximo retorno de los valores de FP16 empaquetados
---

## Descripción

Esta instrucción realiza una comparación SIMD de los valores de FP16 empaquetados en el primer operando de origen y el segundo operando de origen y devuelve el valor máximo para cada par de valores al operando de destino.
