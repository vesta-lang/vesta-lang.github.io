---
summary: Interrupt Return
---

## Description

Returns program control from an exception or interrupt handler to a program or procedure that was interrupted by an exception, an external interrupt, or a software-generated interrupt. These instructions are also used to perform a return from a nested task. (A nested task is created when a CALL instruction is used to initiate a task switch or when an interrupt or exception causes a task switch to an interrupt or exception handler.) See the section titled "Task Linking" in Chapter 10 of the Intel(R) 64 and IA-32 Architectures Software Developer's Manual, Volume 3A.
...
If nonmaskable interrupts (NMIs) are blocked (see Section 7.7.1, "Handling Multiple NMIs" in the Intel(R) 64 and IA-32 Architectures Software Developer's Manual, Volume 3A), execution of the IRET instruction unblocks NMIs.
...
Instruction ordering. IRET is a serializing instruction. See Section 11.3 of the Intel(R) 64 and IA-32 Architectures Software Developer's Manual, Volume 3A.

See "Changes to Instruction Behavior in VMX Non-Root Operation" in Chapter 28 of the Intel(R) 64 and IA-32 Architectures Software Developer's Manual, Volume 3C, for more information about the behavior of this instruction in VMX non-root operation.
