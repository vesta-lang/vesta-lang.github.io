---
summary: Reúne Dword empaquetada, Qword empacada con índices de Dword firmados
---

## Descripción

Se reúnen un conjunto de 16 o 8 ubicaciones de memoria de palabra doble o palabra cuádruple apuntadas por dirección base BASE ADDR y vector de índice VINDEX con escala SCALE. El resultado está escrito en vector zmm1. Los elementos se especifican a través del VSIB (es decir, el registro de índice es un zmm, conteniendo índices empaquetados). Los elementos sólo serán cargados si su bit de máscara correspondiente es uno. Si no se establece el bit de máscara de un elemento, el elemento correspondiente del registro de destino (zmm1) queda sin cambios. El registro completo de máscaras se establecerá a cero por esta instrucción a menos que desencadena una excepción.
