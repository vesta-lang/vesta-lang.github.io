---
summary: Load Internal Wrapping Key With Key Locker
---
...
* The 256-bit encryption key is loaded from the two explicit operands. * The 128-bit integrity key is loaded from the implicit operand XMM0.
