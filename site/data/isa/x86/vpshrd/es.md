---
summary: Datos de Concatenado y Shift Packed Derecho Logical
---

## Descripción

Datos empaquetados concatenados, resultado de extracto se desplaza a la derecha por valor constante. Esta instrucción admite la supresión de la falla de memoria.
