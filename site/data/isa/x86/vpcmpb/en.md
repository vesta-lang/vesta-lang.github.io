---
summary: Compare Packed Byte Values Into Mask
---
...
:                               Table 5-19. Pseudo-Op and VPCMP* Implementation PCMPM Implementation Pseudo-Op                                                                 VPCMP* reg1, reg2, reg3, 0 VPCMPEQ* reg1, reg2, reg3                                                 VPCMP*reg1, reg2, reg3, 1 VPCMPLT* reg1, reg2, reg3                                                 VPCMP* reg1, reg2, reg3, 2 VPCMPLE* reg1, reg2, reg3                                                 VPCMP* reg1, reg2, reg3, 4 VPCMPNEQ* reg1, reg2, reg3                                                VPCMP* reg1, reg2, reg3, 5 VPPCMPNLT* reg1, reg2, reg3                                               VPCMP* reg1, reg2, reg3, 6 VPCMPNLE* reg1, reg2, reg3
