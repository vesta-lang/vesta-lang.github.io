---
summary: Full Permute From Two Tables Overwriting One Table
---

## Descripción

Permutes 16-bit/32-bit/64-bit valores en el primer operando y el tercer operando (el segundo operando de origen) utilizando índices en el segundo operando (el primer operando de origen) para seleccionar elementos de la primera y tercera operandos. Los elementos seleccionados se escriben al operando de destino (el primer operando) según la máscara de escritura k1.

El primero y segundo operandos son los registros ZMM/YMM/XMM. El segundo operando contiene índices de entrada para seleccionar elementos de las dos tablas de entrada en el primer y tercer operandos. El primer operando es también el destino del resultado.
...
Tenga en cuenta que estas instrucciones permiten copiar un valor de 16-bit/32-bit/64-bit en los operandos de origen a más de un lugar en el operando de destino. Tenga en cuenta también que en este caso, el mismo índice se puede reutilizar por ejemplo para una segunda iteración, mientras que los elementos de tabla que están permutados están sobrescritos.
...
VPERMT2D/Q/PS/PD: Ver Tabla 2-52, "Tipo E4NF Clase Condiciones de Excepción." VPERMT2W: Ver Excepciones Tipo E4NF.nb en la tabla 2-52, "Tipo E4NF Clase Condiciones de Excepción."
