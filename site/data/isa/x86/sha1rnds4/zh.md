---
summary: 执行 SHA1 四轮操作
---

## 说明

SHA1RNDS4指令使用第一个操作数的初始SHA1状态(A,B,C,D)进行四轮SHA1操作(它是一个源操作数和目标操作数),并预算下4个圆电文双字的和数,以及第二个操作数(a 源操作数)的变数E. 经过四轮处理后更新的SHA1状态(A,B,C,D)被存储在目标操作数中.
