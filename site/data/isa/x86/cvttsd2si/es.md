---
summary: Convertir Con Truncation valores en coma flotante de precisión doble escalares en Signed
---

## Descripción

Convierte un valor en coma flotante de precisión doble en el operando de origen (el segundo operando) a un entero de doble palabra firmado (o integer de cuádword firmado si tamaño de operando es 64 bits) en el operando de destino (el primer operando). El operando de origen puede ser un registro XMM o una ubicación de memoria de 64 bits. El operando de destino es un registro de proposito general. Cuando el operando de origen es un registro XMM, el valor en coma flotante de precisión doble está contenido en el bajo cuadword del registro.
...
El software debe asegurar que VCVTTSD2SI esté codificado con VEX.L=0. Codificar VCVTTSD2SI con VEX.L=1 puede encontrar un comportamiento impredecible en diferentes generaciones de procesadores.
