---
summary: Subtracto horizontal envasado
---

## Descripción

(V)PHSUBW realiza la resta horizontal en cada par adyacente de 16 bits enteros con signo restando la palabra mas significativo de la palabra menos significativo de cada par en la fuente y operandos de destino, y empaca los resultados firmados de 16 bits al operando de destino (primer operando). (V)PHSUBD realiza la resta horizontal en cada par adyacente de 32 bits enteros con signo restando la palabra doble mas significativo de la palabra doble menos significativo de cada par, y empaqueta el resultado de 32 bits firmado al operando de destino. Cuando el operando de origen es un operando de memoria de 128 bits, el operando debe estar alineado en un límite de 16 bytes o una excepción de protección general (#GP) se generará.
