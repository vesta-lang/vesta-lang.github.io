---
summary: Máximo de valores en coma flotante de precisión doble empaquetados
---

## Descripción

Realiza una comparación SIMD de los valores en coma flotante de precisión doble empaquetados en el primer operando de origen y el segundo operando de origen y devuelve el valor máximo para cada par de valores al operando de destino.
