---
summary: Make Stack Frame for Procedure Parameters
---
...
* The companion LEAVE instruction must also use the 66H prefix, * The value in the RBP/EBP register prior to executing "66H ENTER" must be within the same 16KByte region of

the current stack pointer (RSP/ESP), such that the value of RBP/EBP after "66H ENTER" remains a valid address in the stack. This ensures "66H LEAVE" can restore 16-bits of data from the stack.
