---
summary: Convertir con Truncation Packed FP16 Values to Signed Quadword Integers
---

## Descripción

Esta instrucción convierte los valores de FP16 empaquetados en el operando de origen para firmar enteros de cuádpago en el operando de destino.
