---
summary: Condicional SIMD Empaquetado cargas y tiendas
---
...
VMASKMOV no se debe utilizar para acceder a la memoria mapeada I/O y la memoria no grabada como el acceso y el orden de las cargas individuales o las tiendas que hace es la implementación específica.
...
```c
__m256 _mm256_maskload_ps(float const *a, __m256i mask) void _mm256_maskstore_ps(float *a, __m256i mask, __m256 b) __m256d _mm256_maskload_pd(double *a, __m256i mask);
void _mm256_maskstore_pd(double *a, __m256i mask, __m256d b);
__m128 _mm_maskload_ps(float const *a, __m128i mask) void _mm_maskstore_ps(float *a, __m128i mask, __m128 b) __m128d _mm_maskload_pd(double const *a, __m128i mask);
