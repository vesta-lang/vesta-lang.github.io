---
summary: Report the SMX Parameters
---
...
| --- | --- | --- |
| 5 | Processor based S-CRTM | Returns 1 if this processor implements a processor-rooted S-CRTM capability and 0 if |
|  | support | not (S-CRTM is rooted in BIOS). This flag cannot be used to infer whether the chipset supports TXT or whether the processor support SMX. |
...
EAX Bit Position  Table 7-9. External Memory Types Using Parameter 3 8                            Parameter Description 9                            Uncacheable (UC) 11:10                        Write Combining (WC) 12                           Reserved Write-through (WT)

13                                                                                                          SAFER MODE EXTENSIONS REFERENCE 14 31:15                    Table 7-9. External Memory Types Using Parameter 3 (Contd.) Write-protected (WP) Write-back (WB) Reserved
...
Use of Prefixes  Causes #UD. LOCK             Cause #UD (includes REPNE/REPNZ and REP/REPE/REPZ). REP*             Causes #UD. Operand size
