---
summary: Inclusive logística O
---

## Descripción

Realiza una operación OR un poco inclusiva entre el destino (primero) y la fuente (segundo) operandos y almacena el resultado en la ubicación del operando de destino. El operando de origen puede ser un registro inmediato, un registro, o una ubicación de memoria; el operando de destino puede ser un registro o una ubicación de memoria. (Sin embargo, dos operandos de memoria no se pueden utilizar en una instrucción.) Cada parte del resultado de la instrucción OR se establece a 0 si ambos bits correspondientes de la primera y segunda operandos son 0; de lo contrario, cada bit se establece a 1.
