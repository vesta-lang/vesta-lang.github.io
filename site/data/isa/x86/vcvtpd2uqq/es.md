...
Convierte valores en coma flotante de precisión doble empaquetados en el operando de origen (segundo operando) para empaquetar enteros sin firmar en el operando de destino (primer operando).
