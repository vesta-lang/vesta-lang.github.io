---
summary: Divide escalar FP16 Valores
---

## Descripción

Esta instrucción divide el valor FP16 bajo del primer operando de origen por el valor correspondiente en el segundo operando de origen, almacenando el resultado FP16 en el operando de destino. Los bits 127:16 del operando de destino son copiados de los bits correspondientes del primer operando de origen. Bits MAXVL-1:128 del operando de destino se ponen a cero. El elemento FP16 bajo del destino se actualiza según la máscara de escritura.
